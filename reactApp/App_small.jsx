...
{/* 
   Fixes::
   -------
   Linecount (comments excluded) = 
   - Styles are in "static/css"   
*/}
...
class App extends React.Component {
   ...
   render() {
      ...
      return (
         {/* These styles are handled by a css file */}
         <div className="outLine">
            <div className="inLine">
               
               <OutputField display={"Cannot divide by 0"}/>
               <div>
               <CalcButtonRow       n1={'Inv'} n2={'Deg'} n3={'x!'} n4={"("} n5={")"} n6={"C"} n7={"<<"} />
...
class CalcButton extends React.Component {
   ...
   render()
   {
      ...
      return(
         <button className={this.props.view> {this.props.keyname} </button>
      )
   }
}
